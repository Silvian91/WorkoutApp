...
import com.example.workoutnotebook.domain.user.IsUserDBEmptyUseCase.Output.DBEmpty
import com.example.workoutnotebook.domain.user.IsUserDBEmptyUseCase.Output.DBNotEmpty
